-- Final fix for register_wallet_user function
-- This version completely avoids any ambiguous column references

-- Drop the existing function first
DROP FUNCTION IF EXISTS public.register_wallet_user(TEXT);

-- Create the function with completely unambiguous references
